...
namespace App\Http\Controllers\SpeakerAuth;
...
class ResetPasswordController extends Controller
{
    ...
    public function showResetForm(Request $request, $token = null)
    {
        ...
        return view('speaker.auth.passwords.reset')->with(
    ...
    {
        return Password::broker('speakers');
    }
    ...
    public function reset(Request $request)
    {
        ...
        $speakerStatus = Speaker::select('status')->active()->where('email', '=', $request->email)->first();

        if (empty($speakerStatus)) {
    ...
    protected function sendResetFailedResponse(Request $request, $response)
    {
        ...
        return redirect()->route('speaker.reset.form');
    }
    ...
    public function checkEmail(Request $request)
    {
        ...
        $data = Speaker::active()->where('email', '=', $request->email)->get();
