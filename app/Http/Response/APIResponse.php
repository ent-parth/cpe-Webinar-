...
class APIResponse
{
    ...
    {
        $data = $this->getResponseStructure(true, "", $message);
     ...
     * @return JsonResponse
     */
    public function respondWithMessageAndPayload($payload = "", $message = "Ok")
    {
     ...
     */
    public function respondWithError($message = "Error", $e = null, $data = "")
    {
        $response = null;
     ...
     * @return mixed
     */
    public function respondCreatedWithPayload($payload = "", $message = "Created")
    {
        return $this->setStatusCode(ResponseHTTP::HTTP_CREATED)
     ...
     * @return mixed
     */
    public function respondUpdatedWithPayload($payload = "", $message = "Updated")
    {
        return $this->setStatusCode(ResponseHTTP::HTTP_ACCEPTED)
                        ->respondWithMessageAndPayload($payload, $message);
    }
     ...
     * @return mixed
     */
    public function respondDeletedWithPayload($payload = "", $message = "Deleted")
    {
        return $this->setStatusCode(ResponseHTTP::HTTP_ACCEPTED)
                        ->respondWithMessageAndPayload($payload, $message);
    }
    ...
    public function respondResourceConflictWithData($payload = "", $message = "Resource Already Exists", $responseCode = ResponseHTTP::HTTP_CONFLICT)
    {
