...
abstract class BaseRepository extends \Prettus\Repository\Eloquent\BaseRepository
{
    ...
    public function findByFieldWithOperator($field1, $field2, $field3, $value3, $operator = '=', $columns = ['*'])
    {
        $this->applyCriteria();
        $this->applyScope();
        $model = $this->model->whereColumn($field1, $operator, $field2)->where($field3, '=', $value3)->get($columns);
        $this->resetModel();
