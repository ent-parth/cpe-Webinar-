...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $('body').on('click', '#add-country, .edit-country', function (e) {
        if (popupOpen == false) {
            popupOpen = true;
            $('#add-country-modal').load($(this).attr("data-url"), function (result) {
                $('#add-country-modal').modal({show: true});
            });
        }
    });
