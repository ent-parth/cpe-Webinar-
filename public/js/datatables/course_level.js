...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $('body').on('click', '#add-course-level, .edit-course-level', function (e) {
        if (popupOpen == false) {
            popupOpen = true;
            $('#add-course-level-modal').load($(this).attr("data-url"), function (result) {
                $('#add-course-level-modal').modal({show: true});
            });
        }
    });
    ...
    $("#add-course-level-modal").on("hidden.bs.modal", function () {
        popupOpen = false;
    });
});
