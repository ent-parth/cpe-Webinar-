...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $('body').on('click', '#add-tag, .edit-tag', function (e) {
        if (popupOpen == false) {
            popupOpen = true;
            $('#add-tag-modal').load($(this).attr("data-url"), function (result) {
                $('#add-tag-modal').modal({show: true});
            });
        }
    });
    ...
    $("#add-tag-modal").on("hidden.bs.modal", function () {
        popupOpen = false;
    });
});
