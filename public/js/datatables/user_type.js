...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $('body').on('click', '#add-user-type, .edit-user-type', function (e) {
        if (popupOpen == false) {
            popupOpen = true;
            $('#add-user-type-modal').load($(this).attr("data-url"), function (result) {
                $('#add-user-type-modal').modal({show: true});
            });
        }
    });
    ...
    $("#add-user-type-modal").on("hidden.bs.modal", function () {
        popupOpen = false;
    });
});
