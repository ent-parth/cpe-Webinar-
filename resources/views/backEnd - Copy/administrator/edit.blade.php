  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- /.box-header -->
        <!-- form start -->
        {!! Form::model($administrators, ['name' => 'edit-admin-form', 'id' => 'edit-admin-form', 'class' => '']) !!}
        ...
        {{ Form::hidden('form_type', 'edit') }}
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('email', null, array('id' => 'email', 'class' => 'form-control', 'disabled' => 'disabled', 'placeholder' => __('Email address'), 'autocomplete' => 'off')) }}
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="form-group form-md-checkboxes">
                                      ...
                                      <div class="col-md-9">
                                      <div><input type="checkbox" id="select_all_permissions" class="md-check" /> Select All</div>
                                        <div class="md-checkbox-list">
                                          <?php $permission_title_old = ''; ?>
                                         ...
                                         if($permission_title_old != $permission_title) { ?>
                                            <h3> {{ $permission_title }}</h3>
                                         <?php  } ?>
                                          <div class="md-checkbox">
                                            <input type="checkbox" name="permission[]" id="permission_{{ $permission->id }}" value="{{ $permission->id }}" @if(in_array($permission->
                                            id, $per_role_id)) checked @endif class="md-check" />
                                            <label for="permission_{{ $permission->id }}"> <span></span> <span class="check"></span> <span class="box"></span> {{ $permission->display_name }} </label>
                                          </div>
                                          <?php if(count($permission_arr) > 2) { 
          ...
          <div class="box-footer">
             <div class="col-md-12 text-right">
                <a href="{{ route('administrators') }}" class="btn btn-danger" title="Cancel"> Cancel </a>
