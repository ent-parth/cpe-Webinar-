            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="action pull-right">
                        <a href="javascript:void(0);" id="add-category" class="btn btn-primary" data-url="{{ route('create.category') }}" title="Add Category" data-toggle="modal" data-target="#modal-default">
                            <b><i class="fa fa-plus-circle"></i></b> Add Category
                        </a>
                        <a href="{{ route('delete-all.categories') }}" class="btn btn-danger delete-all" title="Delete All">Delete All</a>
                    </div>
                </div>
                <div class="box-body">
                    <table id="category-list" class="table table-bordered table-hover datatable-highlight">
                        <thead>
                            <tr class="heading">
...
<div class="modal fade" id="add-category-modal"></div>
<style>
...
@endsection
@section('js') 
{{ HTML::script('/js/datatables/category.js') }} 
