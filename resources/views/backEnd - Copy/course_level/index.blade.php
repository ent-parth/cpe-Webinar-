            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="action pull-right">
                    	<a href="javascript:void(0);" id="add-course-level" class="btn btn-primary" data-url="{{ route('create.course_level') }}" title="Add Course Level" data-toggle="modal" data-target="#modal-default">
                        <b><i class="fa fa-plus-circle"></i></b> Add Course Level
                    	</a>
                    	<a href="{{ route('delete-all.course_level') }}" class="btn btn-danger delete-all" title="Delete All">Delete All</a>
                    </div>
                </div>
                <div class="box-body">
                    <table id="course-level-list" class="table table-bordered table-hover datatable-highlight">
                        <thead>
                            <tr class="heading">
...
<div class="modal fade" id="add-course-level-modal"></div>
<style>
...
@endsection
@section('js') 
{{ HTML::script('/js/datatables/course_level.js') }} 
