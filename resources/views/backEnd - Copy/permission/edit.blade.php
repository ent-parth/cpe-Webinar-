              ...
              <div class="col-md-12">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" minlength="2" maxlength="255" placeholder="permission Name" required="required" name="name" id="name" class="form-control" value="{{$permission_edit->name}}">
                    </div>
                    
                    <div class="form-group">
                      <label class="control-label"> Display Name <span aria-required="true" class="required"> * </span></label>
                      <input type="text" minlength="2" maxlength="255" placeholder="permission Name" required="required" name="display_name" id="display_name" class="form-control" value="{{$permission_edit->display_name}}">
                    </div>
                    
                    <div class="form-group">
                      <label class="control-label"> Description <span aria-required="true" class="required"> * </span></label>
                      <textarea minlength="2" maxlength="255" placeholder="description" required="required" name="description" id="description" class="form-control">{{$permission_edit->description}}</textarea>
                    </div>
                  </div>  
