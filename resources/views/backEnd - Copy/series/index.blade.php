            ...
            <div class="box">
              <div class="box-header">
                    ...
                    <div class="action pull-right">
                        <a href="{{ route('series.create') }}" class="btn btn-primary" title="Add Series">
                            <b><i class="fa fa-plus-circle"></i></b>Add Series
                        </a>
                ...
                <div class="box-body">
                    	...
                    	<input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <tr class="filter">
                                ...
                                <td>
                                    ...
                                    <a href="/series" class="btn btn-sm btn-default"><i class="fa fa-times"></i> Reset</a>
                                </td>
                            </tr>
                         </form>   
                    ...
                    <div class="pull-right">{{$Series->links()}}</div>
                </div>
            </div>
        </div>
    </div>
