            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="action pull-right">
                        <a href="javascript:void(0);" id="add-tag" class="btn btn-primary" data-url="{{ route('create.tag') }}" title="Add Tag" data-toggle="modal" data-target="#modal-default">
                            <b><i class="fa fa-plus-circle"></i></b> Add Tag
                        </a>
                        <a href="{{ route('delete-all.tags') }}" class="btn btn-danger delete-all" title="Delete All">Delete All</a>
                    </div>
                </div>
                <div class="box-body">
                    <table id="tag-list" class="table table-bordered table-hover datatable-highlight">
                        <thead>
                            <tr class="heading">
                        ...
                        <tfoot>
                            <tr class="filter">
                                <td></td>
                                <td><input type="text" class="form-control form-filter input-sm" name="tag" id="tag"></td>
                                <td>
...
<div class="modal fade" id="add-tag-modal"></div>
<style>
...
@endsection
@section('js') 
{{ HTML::script('/js/datatables/tag.js') }} 
