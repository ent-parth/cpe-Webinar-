<div class="modal-dialog modal-md">
    <div class="modal-content">
        {!! Form::open(['name' => 'add-user-type', 'id' => 'add-user-type-form', 'class' => 'form-horizontal', 'files' => false]) !!}
        ...
        <div class="modal-body">
            <div class="box-body">
                <div class="form-group">
                    ...
                    {{ Form::text('name', null, array('id' => 'name', 'class' => 'form-control', 'placeholder' => __('Subject'))) }}
                </div>
                <div class="form-group">
