            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="action pull-right">
                        <a href="new_permission" class="btn btn-primary" title="Add Permission"> 
                ...
                <div class="box-body">
                    ...
                    <table id="permission-list" class="table table-bordered table-hover datatable-highlight"> 
                        <thead>
                            <tr class="heading">
                                <th width="45%">Name</th>
                        ...
                        <tbody>
                            ...
                            @foreach($paginator as $rl)
                                <tr>
                                    ...
                                    <td>{!! $rl->status; !!}</td>
                                    <td>
                                        <a href="edit_permission/{!! $rl->id; !!}" class="btn btn-primary"><span><i class="fa fa-edit"></i></span></a>
                                        <a href="remove_permission/{!! $rl->id; !!}" class="btn btn-primary"><span><i class="fa fa-remove"></i></span></a>  
                                    </td>
                                </tr> 
                            @endforeach
                        </tbody>
