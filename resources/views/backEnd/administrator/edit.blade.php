      ...
      <div class="box box-primary"> 
        ...
        <div class="box-body">
            ...
            <div class="col-md-6">
          	...
          	@if(CommonHelper::checkLoginUserPermission('permission_edit', Auth::guard('administrator')->user()->id))
          		<div class="row">
                <div class="col-md-12">
                  <div class="form-group form-md-checkboxes">
                    ...
                    <div class="col-md-9">
                      <div>
                        <input type="checkbox" id="select_all_permissions" class="md-check" />
                        Select All</div>
                      <div class="md-checkbox-list"> @php $permission_title_old = ''; @endphp
