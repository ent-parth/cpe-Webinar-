            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="action pull-right">
                        <a href="{{ route('add-administrators') }}" class="btn btn-primary" title="Add Administrator">
                            <b><i class="fa fa-plus-circle"></i></b> Add Administrator
                        </a>
                        <a href="{{ route('delete-all.administrators') }}" class="btn btn-danger delete-all" title="Delete All">Delete All</a>
                    </div>
                </div>
                <div class="box-body">
