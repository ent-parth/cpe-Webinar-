            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="action pull-right">
                        <a href="javascript:void(0);" id="add-country" class="btn btn-primary" data-url="{{ route('create.country') }}" title="Add Country" data-toggle="modal" data-target="#modal-default">
                            <b><i class="fa fa-plus-circle"></i></b> Add Country
                        </a>
                        <a href="{{ route('delete-all.countries') }}" class="btn btn-danger delete-all" title="Delete All">Delete All</a>
                    </div>
                </div>
                <div class="box-body">
                    <table id="country-list" class="table table-bordered table-hover datatable-highlight">
                        <thead>
                            <tr class="heading">
...
<div class="modal fade" id="add-country-modal"></div>
<style>
...
@endsection
@section('js') 
{{ HTML::script('/js/datatables/country.js') }} 
