      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="action pull-right"> 
            <!--<a href="{{ route('live-webinar.create') }}" class="btn btn-primary" title="Add Webinar">
            <b><i class="fa fa-plus-circle"></i></b> Add Live Webinar
            </a> -->
            ...
            <form name="Filter" id="Filter" action="" method="get" >
              ...
              <tr class="filter">
                ...
                <td><button class="btn btn-sm btn-default filter-submit" type="submit" title="Search"><i class="fa fa-search"></i> Search</button>
                  <a href="/live-webinar" class="btn btn-sm btn-default"><i class="fa fa-times"></i> Reset</a></td>
              </tr>
            </form>
            @include('backEnd/live_webinars/index-ajax')
              </tfoot>
