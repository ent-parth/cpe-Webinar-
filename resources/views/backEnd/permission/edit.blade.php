...
<section class="content-header">
  <h1> Edit permission <span class="pull-right small"><a href="/permission"><b>List view</b></a></span></h1>
</section>
  ...
  <div class="row"> 
    ...
    <div class="col-md-12"> 
      ...
      <div class="box box-primary"> 
        <!-- /.box-header --> 
        <!-- form start -->
        <form id="updatePermission" name="updatePermission" action="{{route('permission.update')}}" method="post" enctype="multipart/form-data">
          <div class="box-body">
          <div class="row">
          <div class="col-md-12">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" maxlength="255" placeholder="permission Name" required="required" name="name" id="name" class="form-control" value="{{$permission_edit->name}}">
            </div>
            <div class="form-group">
              <label class="control-label"> Display Name <span aria-required="true" class="required"> * </span></label>
              <input type="text" maxlength="255" placeholder="permission Name" required="required" name="display_name" id="display_name" class="form-control" value="{{$permission_edit->display_name}}">
            </div>
            <div class="form-group">
              <label class="control-label"> Description <span aria-required="true" class="required"> * </span></label>
              <textarea maxlength="255" placeholder="description" required="required" name="description" id="description" class="form-control">{{$permission_edit->description}}</textarea>
            </div>
          </div>
          ...
          <div class="box-footer">
            <div class="col-md-12 text-right"> <a href="{{ route('permission') }}" class="btn btn-danger" title="Cancel"> Cancel </a>
