  ...
  <div class="row"> 
    ...
    <div class="col-md-12"> 
      ...
      <div class="box box-primary"> 
        ...
        <form id="updateWebinarQuestion" name="updateWebinarQuestion" action="{{route('selfystudy.update_webinar_question')}}" method="post" enctype="multipart/form-data">
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <?php /*?><div class="box-footer">
            <div class="col-md-12 text-right">
              ...
              <a href="{{ env('APP_ADMIN_URL').'/selfstudy-webinars/'.$webinars->id.'/add-webinar-question'}}" class="btn btn-primary" title="Cancel"> Add more Question</a> <a href="{{route('selfstudy-webinar')}}" class="btn btn-danger" title="Cancel"> Finish </a> </div>
          </div><?php */?>
          <div class="box-footer">
            <div class="col-md-12 text-right">
              ...
              <input type="hidden" name="webinar_id" value="{{$webinars->id}}">
              <input type="hidden" name="uri" value="{{Request::getQueryString() ? Request::getQueryString() : ''}}"  />
              <a href="{{ env('ADMIN_URL').'/selfstudy-webinars/'.$webinars->id.'/add-webinar-question'}}" class="btn btn-danger" title="Cancel"> Cancel </a> </div>
          </div>
        </form>
      </div>
      <!-- /.box -->
...
<script language="javascript" type="application/javascript">
	...
	var validator = $('#updateWebinarQuestion').validate({
