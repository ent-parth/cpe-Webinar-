...
<section class="content-header">
  <h1> Edit Self Study Webinar <span class="pull-right small"><a href="/selfstudy-webinar"><b>List view</b></a></span></h1>
</section>
      ...
      <div class="col-md-12">
        	<div class="col-md-6">
            	<div class="form-group">
            		...
            		<form id="uploadVideoForm" name="uploadVideoForm" action="{{route('selfystudy-webinar.store_video')}}" method="post">
                	<div>
        ...
        <form id="updateWebinar" name="updateWebinar" action="{{route('selfstudy-webinar.update')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text"  required="required" placeholder="recorded date" autocomplete="off" name="recorded_date" id="recorded_date" value="{{$webinar->recorded_date}}" class="form-control">
          ...
          <div class="box-footer">
            <div class="col-md-12 text-right">  @if(empty($webinar->video)) <p id="noteMsg"><b>Note: </b>Please upload video first to enable Save button</p>@endif 
