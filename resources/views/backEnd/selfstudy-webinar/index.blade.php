    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body">
            ...
            <form name="Filter" id="Filter" action="" method="get" >
              ...
              <tr class="filter">
                ...
                <td><button class="btn btn-sm btn-default filter-submit" type="submit" title="Search"><i class="fa fa-search"></i> Search</button>
                  <a href="/selfstudy-webinar" class="btn btn-sm btn-default"><i class="fa fa-times"></i> Reset</a></td>
              </tr>
            </form>
          ...
          @if($Self_Study_Webinars->total() > 0 )
          <div class="pull-right"> 
          	@if($Self_Study_Webinars->total() > env('PAGINATION'))
            	{{$Self_Study_Webinars->links()}}
            @else
            <ul class="pagination">
