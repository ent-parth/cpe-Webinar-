              ...
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" maxlength="255" placeholder="Series Name" required="required" name="name" id="name" class="form-control">
                  </div>
                </div>
              </div>
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Series Description" class="form-control"></textarea>
                  </div>
                </div>
              </div>
