  ...
  <div class="row"> 
    ...
    <div class="col-md-12"> 
      ...
      <div class="box box-primary"> 
        <!-- /.box-header --> 
        <!-- form start -->
        <form id="editSeries" name="editSeries" action="{{route('series.update')}}" method="post" enctype="multipart/form-data">
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" maxlength="255" placeholder="Series Name" required="required" name="name" id="name" value="{{$Series->name}}" class="form-control">
                  </div>
                </div>
              </div>
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Series Description" class="form-control">{{$Series->description}}</textarea>
                  </div>
                </div>
              </div>
              <div class="box-footer">
                <div class="col-md-12 text-right"> <a href="{{ route('series') }}" class="btn btn-danger" title="Cancel"> Cancel </a>
