  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- /.box-header -->
        <!-- form start -->
        {!! Form::model($speakers, ['name' => 'edit-speaker-form', 'id' => 'edit-speaker-form', 'files' => true]) !!}
          <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                       ...
                       {{ Form::select('company_id', $companyList, null, ["placeholder" => "Select Company", 'class' => 'form-control select2 select-search']) }}
                    </div>
                    <!-- <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="expertise" name="expertise" class="col-md-12">{{$speakers->expertise ?? ''}}</textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label"> About Speaker </label>
                        <textarea id="about_speaker" name="about_speaker" class="col-md-12">{{$speakers->about_speaker ?? ''}}</textarea>
                    </div>
                    <?php /*<div class="form-group">
                        <label class="control-label"> About Company </label>
                        <textarea id="about_company" name="about_company" class="col-md-12">{{$speakers->about_company ?? ''}}</textarea>
                    </div> */?>
                </div>
            </div>
          </div>
    ...
    jQuery(document).ready(function () {
        ...
        $('#country_id, #state_id').on('change', function (e) {
            ...
            if (id == 'country_id') {
                ...
                var selectedId = "<?= $speakers->state_id?>";
            } else if (id == 'state_id') {
                var url = '/cities/get-city';
                var selectedId = "<?= $speakers->city_id?>";
            }
            $.ajax({
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type: 'post',
