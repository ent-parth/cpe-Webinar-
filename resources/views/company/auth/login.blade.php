...
@section('content')
<div class="login-logo" style="color:green !important; font-size:17px !important; ">
	<p>@if(isset($_REQUEST['message'])) {{$_REQUEST['message']}} @endif</p>
</div>
...
<div class="login-box-body">
    ...
    <a href="{{route('company.email.reset.form')}}">I forgot my password</a><br>
  </div>
@endsection
