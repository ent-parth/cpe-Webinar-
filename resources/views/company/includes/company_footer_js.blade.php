...
<script type="text/javascript">
    ...
    var app_site_url  = "<?php echo env('COMPANY_URL').'/' ?>";
    ...
    function checkLanguage() {
        var oldLanguage = '<?php echo !empty(Illuminate\Support\Facades\Auth::guard('company')->user()->language_translation) ? Illuminate\Support\Facades\Auth::guard('company')->user()->language_translation : 'en'; ?>';
