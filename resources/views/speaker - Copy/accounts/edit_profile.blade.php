          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="change-avatar">
                    {!! Form::open(['name' => 'speaker-edit-profile', 'id' => 'speaker-edit-avatar', 'class' => 'form-horizontal', 'files' => true]) !!}
                        <div class="form-group">
                        ...
                        <div class="text-right">
                            <a href="{{ route('speaker.dashboard') }}" class="btn btn-secondary ml-3" title="Cancel"><i class="icon-reply"></i> Cancel</a>
