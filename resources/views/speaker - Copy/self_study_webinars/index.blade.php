        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="{{ route('speaker.self_study_webinars.create') }}" class="btn btn-primary pull-right" title="Add Self Study Webinar">
                    	...
                    	<input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <tr class="filter">
                                ...
                                <td>
                                    ...
                                    <a href="/selfstudy-webinars" class="btn btn-sm btn-default"><i class="fa fa-times"></i> Reset</a>
                                </td>
                            </tr>
                         </form>   
