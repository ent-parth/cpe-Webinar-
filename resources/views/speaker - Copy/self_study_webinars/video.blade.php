  ...
  <div class="row"> 
    ...
    <div class="col-md-12"> 
      ...
      <div class="box box-primary"> 
        <!-- /.box-header --> 
        <!-- form start -->
        <form id="addWebinar" name="addWebinar" action="{{route('speaker.self_study_webinars.store_video')}}" method="post" enctype="multipart/form-data">
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="col-md-6">
                        <div class="form-group">
                              ...
                              <input type="file" required="required" name="video" id="video" class="form-control">
