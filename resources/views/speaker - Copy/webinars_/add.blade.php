    ...
    <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['name' => 'add-webinar-form', 'id' => 'add-webinar-form', 'files' => true]) !!}
              <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input name="date" id="date" readonly type="text" class="form-control" placeholder="date">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="faq" name="faq" class="col-md-12"></textarea>
                            @if ($errors->has('faq'))
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $('#status').val('inactive'); // Select the option with a value of 'US'
