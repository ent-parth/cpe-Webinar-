...
<section class="content-header">
  <h1> Edit Webinar <span class="pull-right"><a href="/selfstudy-webinars">List view</a></span></h1>
</section>
  ...
  <div class="row"> 
    ...
    <div class="col-md-12"> 
      ...
      <div class="box box-primary">
        <div class="col-md-12">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <form id="uploadVideoForm" name="uploadVideoForm" action="{{route('speaker.self_study_webinars.store_video')}}" method="post">
                <div>
                ...
                <!--<div id="loader-icon" style="display:none;"><img src="{{env('SPEAKER_URL')}}/images/basicloader.gif"  height="100" /></div>--> 
        ...
        <!-- /.box-header --> 
        <!-- form start -->
        <form id="updateWebinar" name="updateWebinar" action="{{route('speaker.self_study_webinars.update')}}" method="post" enctype="multipart/form-data">
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <div class="col-md-6"> Free :
                      <input type="radio" name="fee_type" id="fee_tupe" @if(empty($webinar->
                      fee)) checked="checked" @endif required="required" value="0" class="" onclick="feeCheck(this.value);">
                      Paid  :
                      <input type="radio" name="fee_type" id="fee_tupe" @if(!empty($webinar->
                      fee)) checked="checked" @endif required="required" value="1" class="" onclick="feeCheck(this.value);"> </div>
              ...
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    @if($webinar->time_zone != '')
                    <input type="text" name="time_zone" id="time_zone" class="form-control"  value="{{  config('constants.TIME_ZONE')[$webinar->time_zone] }}" disabled="disabled" required="required">
                    @else
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text"  required="required" placeholder="recorded date" name="recorded_date" id="recorded_date" value="{{$webinar->recorded_date}}" class="form-control" autocomplete="off">
              ...
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" min="1" value="{{$webinar->presentation_length}}" required="required" name="presentation_length" id="presentation_length" placeholder="Presentation length in minutes" class="form-control" >
                  </div>
                </div>
              </div>
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="subject_area[]" id="subject_area" class="form-control" required="required" multiple="multiple">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="course_level[]" id="course_level" class="form-control" required="required" multiple="multiple">
              ...
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="who_should_attend[]" id="who_should_attend" class="form-control" multiple="multiple" required="required">
          ...
          <div class="box-footer">
            <div class="col-md-12 text-right"> @if(empty($webinar->video))
              ...
              @endif <a href="{{ route('speaker.self_study_webinars') }}" class="btn btn-danger BtnCancel" title="Cancel"> Cancel </a>
              <button type="submit" class="btn btn-primary ml-3" id="submitBtn" @if(empty($webinar->video)) disabled="disabled" @endif >Save & Next</button>
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <input type="hidden" name="id" value="{{$webinar->id}}">
              <input type="hidden" name="webinar_id" value="{{$webinar->id}}">
              <input type="hidden" name="current_status" value="{{$webinar->status}}">
              <input type="hidden" name="uri" value="{{Request::getQueryString() ? Request::getQueryString() : ''}}"  />
            </div>
          </div>
        </form>
