            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea id="description" name="description" noSpace=true class="form-control" required="required">{{$webinar->description}}</textarea>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="time_zone" id="time_zone_normal" class="form-control"  value="{{ $webinar->time_zone != '' ? config('constants.TIME_ZONE')[$webinar->time_zone] : '' }}" disabled="disabled" required="required">
                    <input type="hidden" name="time_zone_normal" id="time_zone" class="form-control"  value="{{ $webinar->time_zone }}">
                    @else
                    <select name="time_zone" id="time_zone" class="form-control" required="required">
                ...
                @if(!empty($webinar->start_time) && !empty($webinar->time_zone) && !empty($webinar->end_time))
                @php
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text"  required="required" name="start_time"  autocomplete="off" placeholder="start time" id="start_time" value="{{$finaldisplayStartDate}}" class="form-control">
                  </div>
              ...
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text"  required="required" name="end_time"  autocomplete="off" placeholder="end time" id="end_time" value="{{$finaldisplayEndDate}}" class="form-control">
                  </div>
                </div>
              </div>
              <div class="col-md-12">
              ...
              <div class="col-md-12">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="who_should_attend[]" id="who_should_attend" class="form-control" required="required" multiple="multiple">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea id="faq_1" name="faq_1" class="col-md-12">{{$webinar->faq_1}}</textarea>
                </div>
